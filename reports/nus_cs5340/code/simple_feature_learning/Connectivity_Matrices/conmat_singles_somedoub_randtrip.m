...
% input map, the diagonal pairs of input maps, and randomly selected triples of input
% maps.
%
% @file
...
% @date Mar 11, 2010
%
% @conmat_file @copybrief conmat_singles_somedoub_randtrip.m
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%>
% @copybrief conmat_singles_somedoub_randtrip.m
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [C,recommended] = conmat_singles_somedoub_randtrip(xdim,ydim)
...
for j=1:size(C,2)-2*xdim
    indices = randperm(xdim);
    C(indices(1),j+2*xdim)=1;
    C(indices(2),j+2*xdim)=1;
end
