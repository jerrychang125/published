...
% input map, randomly selected pairs of input maps, and the diagonal triples of input
% maps.
%
% @file
...
% @date Mar 11, 2010
%
% @conmat_file @copybrief conmat_singles_randsdoub_sometrip.m
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%>
% @copybrief conmat_singles_randdoub_sometrip.m
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [C,recommended] = conmat_singles_randdoub_sometrip(xdim,ydim)
...
for j=1:size(C,2)-2*xdim
    ...
    C(indices(1),j+xdim)=1;
    C(indices(2),j+xdim)=1;
end
