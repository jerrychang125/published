...
% single input map, all possible pairs of input maps, and all possible triples
% of input maps.
%
% @file
...
% @date Mar 11, 2010
%
% @conmat_file @copybrief conmat_singles_alldoub_alltrip.m
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%>
% @copybrief conmat_singles_alldoub_alltrip.m
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [C,recommended] = conmat_singles_alldoub_alltrip(xdim,ydim)
...
% Put all triples
for j=1:size(indices,1)
    C(indices(j,1),j+start)=1;
    C(indices(j,2),j+start)=1;
    C(indices(j,3),j+start)=1;    
end
